NG7SANS_HEADER = r"""
<p>If you have written a paper that reports measurements using the NG7 30m SANS Instrument and you do not see it in the list below, or if the paper is listed but the 
...
<ol>
<li>include an <A href="/programs/CHRNS/publications.html">acknowledgement</A> to the NSF, and to NIST if there are no NIST coauthors,and</li>
<li>include a reference to the paper describing the 30m SANS Instruments: "<a href="http://dx.doi.org/10.1107/S0021889897017020">The 30 m Small-Angle Neutron Scattering Instruments at the National Institute of Standards and Technology</a>", Glinka CJ, et al. <i>J Appl. Cryst.</i> <b>31</b>(3), 430 (1998).  Thanks!</li>
</ol>
<p>If you reduced your data using the Igor Macros, please include the reference ""<a href="http://dx.doi.org/10.1107/S0021889806035059">Reduction and Analysis of SANS and USANS Data using Igor Pro</a>", Kline, S. R. <i>J Appl. Cryst.</i> <b>39</b>(6), 895 (2006).</p>
<p>Please be aware that all papers with NIST coauthors must be reviewed and approved by the Washington Editorial Review Board (WERB). Members of WERB are concerned not only with scientific merit but with three specific matters: measurement uncertainties, the use of SI units, and brand names. For more detailed information please <A href="https://www.ncnr.nist.gov/WERB.html">read more here</A> and/or speak with your NIST coauthor(s).</p>
...
USANS_HEADER = r"""
<p>If you have written a paper that reports measurements using the USANS Instrument and you do not see it in the list below, or if the paper is listed but the 
information is incorrect or out of date, please inform <a href="mailto:jkrzywon@nist.gov">Jeff Krzywon</a> and/or <a href="mailto:barker@nist.gov">John Barker</a>.</p>
...
SANS_HEADER = r"""
<p>If you have written a paper that reports measurements using any of the SANS instruments (NG3/NG7/NGB30 30m, NGB 10m, NG1 8m, BT5 USANS) and you do not see it in the list below, or if the paper is listed but the 
information is incorrect or out of date, please inform <a href="mailto:jkrzywon@nist.gov">Jeff Krzywon</a> and/or <a href="mailto:butler@nist.gov">Paul Butler</a>.</p>
...
<li>For the NGB 30m SANS, USANS, and VSANS instruments include an <A href="/programs/CHRNS/publications.html"> acknowledgement</A> to the NSF.</li>
